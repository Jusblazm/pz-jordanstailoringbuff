...
function ISColorPickerArbitrary:initialise()
    ...
    local function CommitColor(self, color, mouseUp)
        ...
        print("Committing Color")
        -- clear all the mouseDown flags
        self.mouseDown = false
        self.HuePicker.mouseDown = false
        self.SatBrightPicker.mouseDown = false
    end
...
-- Ensure Clothing_Tints exists before assigning color picker class
if Clothing_Tints then
	Clothing_Tints.colorPickerClass = ISColorPickerArbitrary
end

-- Restore default color picker for other uses in the game
